...
import { LogLevel, Message, StreamCloser, Conversation as Conversation$1, ListMessagesOptions, ConsentState, PermissionUpdateType, PermissionPolicy, MetadataField, Identifier, Conversations as Conversations$1, CreateGroupOptions, CreateDmOptions, ListConversationsOptions, ConversationType, Client as Client$1, Consent, ConsentEntityType, SignatureRequestHandle } from '@xmtp/node-bindings';
...
declare class Preferences {
     ...
     */
    streamPreferences(options?: StreamOptions<PreferenceUpdate>): Promise<AsyncStreamProxy<PreferenceUpdate>>;
}
...
export type { AsyncStreamProxy, ClientOptions, ExtractCodecContentTypes, HexString, NetworkOptions, OtherOptions, PreferenceUpdate, Signer, StorageOptions, StreamCallback, StreamFunction, StreamOptions, StreamValueMutator, XmtpEnv };
